"""
FairFinance AI — OpenAI GPT-4o-mini Data Collection Script
...
Usage:
    ...
    python collect_openai.py --api_key YOUR_OPENAI_KEY
"""
...
def query_openai(client, system_prompt, user_prompt, model="gpt-4o-mini"):
...
def collect(api_key, csv_path="chicago_hardship_index.csv", output_file="fairfinance_openai.csv"):
    ...
    skipped = 0
    print(f"Collecting {total} total responses from GPT-4o-mini...\n")
    ...
    for prompt_type in ["zero_shot", "few_shot", "fairness_instructed"]:
        ...
        for profile in profiles:
            for question in FINANCIAL_QUESTIONS:
                ...
                try:
                    response_text = query_openai(client, system_prompt, user_prompt)
                    record = {
                        "id":                record_id,
                        "model":             "gpt-4o-mini",
...
if __name__ == "__main__":
    ...
    try:
        ...
        parser.add_argument("--output",  default="fairfinance_openai.csv")
